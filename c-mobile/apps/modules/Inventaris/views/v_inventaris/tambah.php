									...
									<div class="form-group">
										...
										<div class="col-sm-6">
											<input type="text" class="form-control" placeholder="Kode Barang"
												name="kode_barang" id="kode_barang" aria-describedby="sizing-addon2" autocomplete="off">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-6">
											<input type="text" class="form-control" placeholder="Nama Barang"
												name="nama_barang" id="nama_barang" aria-describedby="sizing-addon2" autocomplete="off">
										</div>
									</div>
	...
	<script type="text/javascript">	
				...
				$('#form-tambah').submit(function(e) {
					...
					if (error == 0) {
						...
						url: '<?php echo site_url('Inventaris/Inventaris/prosesTambahBarang'); ?>',
						data: data,
						})
						.done(function(data) {
