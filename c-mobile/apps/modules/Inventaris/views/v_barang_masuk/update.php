                                ...
                                <div class="form-group">
                                        ...
                                        <div class="col-sm-2">
                                            <input type="text" class="form-control" placeholder="Tanggal" autocomplete="off"
                                                name="tanggal" id="tanggal" aria-describedby="sizing-addon2" value="<?php echo $barang_masuk->tanggal; ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
										...
										<div class="col-sm-5">
											<select name="id_barang" id="id_barang" class="form-control select-barang">
                                                ...
                                                ?>
												    <option value="<?php echo $data->id_barang ?>" <?php if($data->id_barang == $barang_masuk->id_barang){ echo "selected";} ?>> <?php echo $data->nama_barang ?> </option>
                                                <?php
                                                    }
                                                ?>
											</select>
									...
									<div class="form-group">
										...
										<div class="col-sm-6">
											<input type="number" class="form-control" placeholder="Jumlah"
												name="jumlah" id="jumlah" aria-describedby="sizing-addon2" autocomplete="off" value="<?php echo $barang_masuk->jumlah; ?>">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-6">
											<input type="text" class="form-control" placeholder="Keterangan"
												name="keterangan" id="keterangan" aria-describedby="sizing-addon2" autocomplete="off" value="<?php echo $barang_masuk->keterangan; ?>">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-5">
											<select name="lokasi" id="lokasi" class="form-control select-kategori">
												<option></option>
												<option value="tubanan" <?php if($barang_masuk->lokasi == "tubanan"){ echo "selected"; } ?>> Tubanan </option>
												<option value="nginden" <?php if($barang_masuk->lokasi == "nginden"){ echo "selected"; } ?>> Nginden </option>
											</select>
										</div>
									</div>
								  ...
								  <div class="box-footer">
									...
									<a class="klik ajaxify" href="<?php echo site_url('barang-masuk'); ?>"><button class="btn btn-primary btn-flat" ><i class="fa fa-arrow-left"></i> Kembali</button></a>
								  </div>
								</div>
							</div>
						</div>
	...
	<script type="text/javascript">	
				...
				$('#form-update').submit(function(e) {
					...
					if (error == 0) {
						...
						url: '<?php echo site_url('Inventaris/Barang_masuk/prosesUpdateBarangMasuk'); ?>',
						data: data,
						})
						.done(function(data) {
