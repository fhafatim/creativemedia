					...
					<div class="tab-content">
						<div class="active tab-pane" id="kursus">
							...
							<div class="form-group">
								...
								<div class="col-sm-5">
									<select name="jenis_surat" id="jenis_surat" class="form-control select-kategori" required>
										<option></option>
							...
							<div class="form-group">
								...
								<div class="col-sm-2">
									<input type="text" class="form-control" placeholder="Tanggal" autocomplete="off" name="tanggal" id="tanggal" aria-describedby="sizing-addon2" required>
								</div>
							</div>
							...
							<div class="form-group kodeSuratReq">
								...
								<div class="col-sm-6">
									<input type="text" class="form-control kodeSurat" placeholder="Contoh : SPK" name="perihal" id="perihal" aria-describedby="sizing-addon2" autocomplete="off" required>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-6">
									<input type="text" class="form-control" placeholder="Isi/Keterangan" name="keterangan" id="keterangan" aria-describedby="sizing-addon2" autocomplete="off" required>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-6">
									<input type="text" class="form-control" placeholder="Kepada/Dari" name="dibuat" id="dibuat" aria-describedby="sizing-addon2" autocomplete="off" required>
								</div>
							</div>
							...
							<div class="box-footer">
								...
								<a class="klik ajaxify" href="<?php echo site_url('surat-nginden'); ?>"><button class="btn btn-primary btn-flat"><i class="fa fa-arrow-left"></i> Kembali</button></a>
							</div>
						</div>
					</div>
				</div>
	...
	$('#form-tambah').submit(function(e) {
		...
		if (error == 0) {
			$.ajax({
					...
					url: '<?php echo site_url('Surat/Surat_nginden/ProsesTambahSurat'); ?>',
