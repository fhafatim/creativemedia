...
.select-tempat-daftar {
							...
							<div class="tab-content">								
								<div class="active tab-pane" id="kursus">
									...
									<div class="form-group">
										...
										<div class="col-sm-6">
											<input type="text" class="form-control nomorSurat" placeholder="Nomor Surat"
												name="nomor_surat" id="nomor_surat" aria-describedby="sizing-addon2" autocomplete="off" value="<?php echo $surat->nomor_surat ?>" <?= $surat->jenis_surat == "surat masuk" ? '' : 'readonly' ?>>
										</div>
									</div>
									...
									<div class="form-group kodeSuratReq">
										...
										<div class="col-sm-6">
											<input type="text" class="form-control kodeSurat" placeholder="Contoh : SPK"
									...
									<div class="form-group">
										<label for="inputEmail3" class="col-sm-2 control-label">File&nbsp<span style="color: grey; font-size: 10px;">Hanya pdf</span></label>
										<div class="col-sm-6">
	...
	<script type="text/javascript">	
				...
				$('#form-update').submit(function(e) {
					...
					// 	$(".loading2").modal('show');	
					// 	},
					// 	url: '<?php echo site_url('Surat/Surat_nginden/prosesUpdateSurat'); ?>',
		...
		$(function() {
			...
			$('.select-kategori').on('select2:select', function(e) {
				...
				if (data.text.includes("Masuk")) {
					...
					$(".nomorSurat").val('<?= $surat->nomor_surat ?>');
