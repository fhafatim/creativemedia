                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-2">
                                            <input type="text" class="form-control" placeholder="Tanggal" autocomplete="off"
                                                name="tanggal" id="tanggal" aria-describedby="sizing-addon2">
                                        </div>
                                    </div>
									...
									<div class="form-group">
										...
										<div class="col-sm-6">
											<input type="number" class="form-control" placeholder="Jumlah"
												name="jumlah" id="jumlah" aria-describedby="sizing-addon2" autocomplete="off">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-6">
											<input type="text" class="form-control" placeholder="Keterangan"
												name="keterangan" id="keterangan" aria-describedby="sizing-addon2" autocomplete="off">
										</div>
									</div>
	...
	<script type="text/javascript">	
				...
				$('#form-tambah').submit(function(e) {
					...
					if (error == 0) {
						...
						url: '<?php echo site_url('Inventaris/Barang_masuk/prosesTambahBarangMasuk'); ?>',
						data: data,
						})
						.done(function(data) {
