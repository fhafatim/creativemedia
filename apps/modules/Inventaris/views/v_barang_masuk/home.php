...
<section class="content">
    <div class="box">
        <div class="box-header">
            <div class="row">
                <div class="col-md-3">
                    <a class="klik ajaxify" href="<?php echo site_url('add-barang-masuk'); ?>"><button
...
$(document).ready(function() {
    ...
    table = $('#table').DataTable({
        ...
        "ajax": {
            "url": "<?php echo base_url('Inventaris/Barang_masuk/ajax_list')?>",
            "type": "POST"
        },
...
$(document).on("click", ".hapus-barang-masuk", function() {
    var id_barang_masuk = $(this).attr("data-id");
    ...
    swal({
        ...
        function() {
            $.ajax({
                url: '<?php echo base_url();?>Inventaris/Barang_masuk/hapus',
                method: "POST",
